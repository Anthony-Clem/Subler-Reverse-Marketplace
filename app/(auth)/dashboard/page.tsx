    ...
    <div className="space-y-8 max-w-6xl text-[#0e1442]">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-[#1e2d8c] p-8 md:p-10 text-white shadow-xs border border-neutral-200/10">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <div>
              <p className="text-caption text-blue-200 font-medium">Welcome back, {(profile?.email || session?.user?.email)?.split("@")[0] || "Renter"} 👋</p>
          ...
          <div className="flex items-center gap-3 shrink-0 self-start md:self-auto">
            {isHost ? (
              <Link
                href="/host/dashboard"
                className="inline-flex h-10 items-center justify-center px-4 rounded-lg bg-[#ffb13d] text-[#0e1442] text-body-sm font-bold hover:bg-[#ffb13d]/90 transition-all active:scale-[0.98] cursor-pointer"
              >
      ...
      {isLoading && (
        <div className="space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white border border-neutral-200/60 rounded-2xl p-6 h-28 animate-pulse" />
            ))}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              {[1, 2].map((i) => (
                <div key={i} className="bg-white border border-neutral-200/60 rounded-2xl p-6 h-56 animate-pulse" />
              ))}
            </div>
      ...
      {error && !isLoading && (
        <div className="p-8 rounded-2xl bg-red-500/5 border border-red-500/10 text-center max-w-xl mx-auto shadow-xs">
          <p className="text-body text-red-600 font-semibold">Failed to load requests</p>
          <p className="text-body-sm text-muted-foreground mt-1.5">Please try reloading the page.</p>
        </div>
      )}
      ...
      {!isLoading && !error && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-neutral-200/60 rounded-2xl p-6 shadow-xs relative overflow-hidden group">
              ...
              <div className="mt-4">
                ...
                <p className="font-display text-3xl font-bold text-[#0e1442] mt-1">{requests?.length || 0}</p>
                <p className="text-[11px] text-slate-500 mt-1">Event requirements submitted</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-neutral-200/60 rounded-2xl p-6 shadow-xs relative overflow-hidden group">
              <div className="flex items-start justify-between">
                ...
                <span className="text-[11px] font-semibold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">Live matching</span>
              </div>
              <div className="mt-4">
                <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Active Requests</p>
                <p className="font-display text-3xl font-bold text-[#0e1442] mt-1">{activeRequests.length}</p>
                <p className="text-[11px] text-slate-500 mt-1">Open space matching posts</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-neutral-200/60 rounded-2xl p-6 shadow-xs relative overflow-hidden group">
              ...
              <div className="mt-4">
                <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Proposals Received</p>
                <p className="font-display text-3xl font-bold text-[#0e1442] mt-1">{totalProposals}</p>
                <p className="text-[11px] text-slate-500 mt-1">Verified host pitches received</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-caption font-bold text-slate-500 uppercase tracking-wider">Quick Actions</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              ...
              >
                ...
                <h4 className="text-body-sm font-bold text-[#0e1442] flex items-center gap-1">
                  Create Request <ArrowUpRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                </h4>
                <p className="text-[11px] text-slate-500 mt-1">Post a new space requirement and invite proposals.</p>
              </Link>
              ...
              >
                ...
                <h4 className="text-body-sm font-bold text-[#0e1442] flex items-center gap-1">
                  View Proposals <ArrowUpRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                </h4>
                <p className="text-[11px] text-slate-500 mt-1">Check matching pitches and review details.</p>
              </Link>
              ...
              {isHost ? (
                ...
                >
                  ...
                  <h4 className="text-body-sm font-bold text-[#0e1442] flex items-center gap-1">
                    Browse Requests <ArrowUpRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                  </h4>
                  <p className="text-[11px] text-slate-500 mt-1">Search active renter requirements and submit offers.</p>
                </Link>
              ) : (
                <Link
                  href="/host/upgrade"
                ...
                >
                  ...
                  <h4 className="text-body-sm font-bold text-[#0e1442] flex items-center gap-1">
                    Upgrade to Host <ArrowUpRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                  </h4>
                  <p className="text-[11px] text-slate-500 mt-1">Register your space to pitch pitches to active renters.</p>
                </Link>
              )}
              ...
              >
                ...
                <h4 className="text-body-sm font-bold text-[#0e1442] flex items-center gap-1">
                  How It Works <ArrowUpRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                </h4>
                <p className="text-[11px] text-slate-500 mt-1">View the layout guides and platform workflows.</p>
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center justify-between border-b border-neutral-200/60 pb-3">
                <h2 className="text-caption font-bold text-slate-500 uppercase tracking-wider">Active Space Requests</h2>
                {requests && requests.length > 0 && (
                  <span className="text-[11px] text-slate-400 font-semibold">Showing {requests.length} posts</span>
                )}
              </div>
              ...
              {(!requests || requests.length === 0) && (
                <div className="bg-white border border-neutral-200/60 rounded-2xl p-10 md:p-14 text-center shadow-xs">
                  ...
                  <p className="text-body-sm text-slate-500 max-w-sm mx-auto mb-6 leading-relaxed">
                    Create your first request and let verified hosts compete for your business. Bids will appear here.
                  </p>
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-start justify-between gap-4 pb-4 border-b border-neutral-100">
                        <div>
                          <div className="flex flex-wrap items-center gap-2 mb-2">
                            <span className="inline-flex items-center text-[10px] font-bold tracking-wide uppercase px-2 py-0.5 rounded-md bg-neutral-50 text-slate-700 border border-neutral-200 capitalize">
                              {request.spaceType}
                            </span>
                            <span className="inline-flex items-center text-[10px] font-bold tracking-wide uppercase px-2 py-0.5 rounded-md bg-neutral-50 text-slate-700 border border-neutral-200 capitalize">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-body-sm pb-4 border-b border-neutral-100">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">Budget</p>
                            <p className="font-bold text-[#0e1442]">${request.budget}/hr</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2.5">
                          <div className="h-8 w-8 rounded-lg bg-neutral-50 flex items-center justify-center text-slate-600">
                          ...
                          <div>
                            <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">Headcount</p>
                            <p className="font-bold text-[#0e1442]">{request.headcount} people</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2.5">
                          <div className="h-8 w-8 rounded-lg bg-neutral-50 flex items-center justify-center text-slate-600">
                          ...
                          <div>
                            ...
                            <p className="font-bold text-[#0e1442] truncate max-w-[120px]" title={request.locationPreference}>
                        ...
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">Dates</p>
                            <p className="font-bold text-[#0e1442] truncate max-w-[120px]">
                      ...
                      <div className="space-y-4 pt-2">
                        <div className="flex items-center justify-between">
                          <h4 className="text-body-sm font-bold text-[#0e1442] flex items-center gap-2">
                            <MessageSquare className="h-4 w-4 text-slate-600" /> Proposals Received ({request.proposals?.length || 0})
                          </h4>
                          {request.status === "open" && (
                        ...
                        {(!request.proposals || request.proposals.length === 0) && (
                          <div className="p-6 rounded-xl border border-dashed border-neutral-200/80 bg-neutral-50/50 text-center">
                            <p className="text-body-sm text-slate-500">
                              No proposals received yet. Active hosts are reviewing your request.
                            </p>
                          </div>
                        )}
                            ...
                            {request.proposals.map((proposal) => (
                              ...
                              >
                                ...
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-[#ffb13d] text-[#0e1442] hover:bg-[#ffb13d]/90 text-body-sm font-semibold transition-all cursor-pointer self-start md:self-auto shrink-0 shadow-xs active:scale-[0.98]"
                                >
            ...
            <div className="space-y-6">
              <div className="border-b border-neutral-200/60 pb-3">
                <h3 className="text-caption font-bold text-slate-500 uppercase tracking-wider flex items-center gap-2">
                  <Activity className="h-4 w-4 text-slate-600" /> Recent Activity
                </h3>
              </div>
              <div className="bg-white border border-neutral-200/60 rounded-2xl p-5 shadow-xs space-y-6">
                ...
                <div className="relative border-l border-neutral-200 pl-5 ml-2.5 space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <div>
                      <p className="text-[11.5px] font-semibold text-[#0e1442]">Matching live hosts</p>
                      <p className="text-[11px] text-slate-500 mt-0.5 font-medium">Verified facility owners are reviewing active submissions.</p>
                      <span className="text-[10px] text-slate-400 font-semibold block mt-1.5">Just now</span>
                    </div>
                  </div>

                  {/* Dynamic Timeline items based on requests */}
                  {requests && requests.slice(0, 3).map((req) => {
                    const hasProposals = req.proposals && req.proposals.length > 0;
                    return (
                      <div key={req.id} className="relative">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500 mt-0.5">
                            Seeking {req.spaceType} space for {req.headcount} people in {req.locationPreference}.
                          </p>
                          {hasProposals && (
                            <div className="mt-2 flex items-center gap-1.5 text-[10px] font-semibold text-amber-700 bg-amber-50 px-2 py-0.5 rounded-md border border-amber-200 self-start w-fit">
                              <MessageSquare className="h-3 w-3" /> Proposal received
                            </div>
                          )}
                  ...
                  {(!requests || requests.length < 2) && (
                    <>
                      <div className="relative">
                        ...
                        <div>
                          <p className="text-[11.5px] font-semibold text-[#0e1442]">Complete reverse-matching setup</p>
                          <p className="text-[11px] text-slate-500 mt-0.5">Create your request parameters to get bids.</p>
                          <span className="text-[10px] text-slate-400 font-semibold block mt-1.5">Step 2 of 3</span>
                        </div>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <div>
                          <p className="text-[11.5px] font-semibold text-[#0e1442]">Welcome to Reverse Marketplace</p>
                          <p className="text-[11px] text-slate-500 mt-0.5">Verified renter profile activated successfully.</p>
                          <span className="text-[10px] text-slate-400 font-semibold block mt-1.5">Step 1 of 3</span>
                        </div>
                      </div>
                    </>
                  )}
